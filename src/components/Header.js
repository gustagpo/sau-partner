            ...
            <Link as={RouterLink} to='/users' display="flex" algin="center">
              <Flex align="center">
                <Box mr="4" textAlign="right" >
                  <Text color="#004AAD">Empresa Parceira</Text>
                  <Text color="#gray.500" fontSize="small" >48.908.091/0001-10</Text>
                </Box>

                <Avatar size="md" name="Empresa Parceira" src="https://avatars.githubusercontent.com/u/77734338" />
              </Flex>
            </Link>
          </Flex>
